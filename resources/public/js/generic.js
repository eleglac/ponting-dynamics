...
cljs.core.with_meta = function with_meta(b, c) {
  return cljs.core.fn_QMARK_.call(null, b) && !(b ? b.cljs$lang$protocol_mask$partition0$ & 262144 || b.cljs$core$IWithMeta$ || (b.cljs$lang$protocol_mask$partition0$ ? 0 : cljs.core.native_satisfies_QMARK_.call(null, cljs.core.IWithMeta, b)) : cljs.core.native_satisfies_QMARK_.call(null, cljs.core.IWithMeta, b)) ? with_meta.call(null, function() {
    "undefined" === typeof cljs.core.t6181 && (cljs.core.t6181 = function(b, c, f, g) {
      this.meta = b;
      this.o = c;
      this.with_meta = f;
      this.meta6182 = g;
    ...
    }, cljs.core.t6181.cljs$lang$type = !0, cljs.core.t6181.cljs$lang$ctorStr = "cljs.core/t6181", cljs.core.t6181.cljs$lang$ctorPrWriter = function(b, c, f) {
      return cljs.core._write.call(null, c, "cljs.core/t6181")
    }, cljs.core.t6181.prototype.call = function() {
      var b = function(b, c) {
      ...
      c.cljs$core$IFn$_invoke$arity$variadic = b;
      return c
    }(), cljs.core.t6181.prototype.apply = function(b, c) {
      return this.call.apply(this, [this].concat(cljs.core.aclone.call(null, c)))
    }, cljs.core.t6181.prototype.cljs$core$IFn$_invoke$arity$2 = function() {
      var b = function(b) {
      ...
      c.cljs$core$IFn$_invoke$arity$variadic = b;
      return c
    }(), cljs.core.t6181.prototype.cljs$core$Fn$ = !0, cljs.core.t6181.prototype.cljs$core$IMeta$_meta$arity$1 = function(b) {
      return this.meta6182
    }, cljs.core.t6181.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = function(b, c) {
      return new cljs.core.t6181(this.meta, this.o, this.with_meta, c)
    }, cljs.core.__GT_t6181 = function(b, c, f, g) {
      return new cljs.core.t6181(b, c, f, g)
    });
    return new cljs.core.t6181(c, b, with_meta, null)
...
jayq.core.preprocess_request = function(a) {
  ...
  return function(a) {
    return cljs.core.truth_(cljs.core.truth_(d) ? jayq.core.clj_content_type_QMARK_.call(null, d) : d) ? cljs.core.assoc.call(null, a, new cljs.core.Keyword(null, "data", "data", 1016980252), cljs.core.pr_str.call(null, c)) : a
...
var ponting_dynamics = {dynamic:{}};
ponting_dynamics.dynamic.backgrounds = new cljs.core.PersistentVector(null, 7, 5, cljs.core.PersistentVector.EMPTY_NODE, "../img/wood-water.jpg ../img/blurry-city-traffic.jpg ../img/library-books.jpg ../img/orange-tree.jpg ../img/old-tools.jpg ../img/designer-desk.jpg ../img/desk-and-chair.jpg".split(" "), null);
ponting_dynamics.dynamic.make_highlightable = function(a, b) {
  jayq.core.css.call(null, a, new cljs.core.Keyword(null, "background-color", "background-color", 1619226998));
  var c = jayq.core.html.call(null, a);
  return jayq.core.hover.call(null, a, function() {
    return jayq.core.html.call(null, a, [cljs.core.str(c), cljs.core.str(" \x26raquo;")].join(""))
  }, function() {
    return jayq.core.html.call(null, a, c)
  })
};
ponting_dynamics.generic = {};
ponting_dynamics.generic.ship_start = cljs.core.rand_int.call(null, 8);
ponting_dynamics.generic.ship = new cljs.core.PersistentArrayMap.fromArray(["" + cljs.core.str(ponting_dynamics.generic.ship_start), !1, "" + cljs.core.str(ponting_dynamics.generic.ship_start + 1), !1, "" + cljs.core.str(ponting_dynamics.generic.ship_start + 2), !1], !0, !1);
ponting_dynamics.generic.and_fn = function() {
  var a = function(a) {
    return cljs.core.empty_QMARK_.call(null, cljs.core.filter.call(null, function(a) {
...
ponting_dynamics.generic.hit_QMARK_ = function(a, b) {
  if(cljs.core.contains_QMARK_.call(null, a, b) && cljs.core.not.call(null, a.call(null, b))) {
    return alert("A hit!  Dozens die in agony."), cljs.core.assoc.call(null, a, b, !0)
  }
  alert("A miss.  The sailors thank their lucky stars.");
  return a
};
ponting_dynamics.generic.fire_shot = function(a, b) {
  return cljs.core.truth_(function() {
    var c = cljs.core.contains_QMARK_.call(null, a, b);
    return c ? a.call(null, b) : c
  }()) ? (alert("You already hit that section, Queeg :/"), a) : ponting_dynamics.generic.hit_QMARK_.call(null, a, b)
};
ponting_dynamics.generic.is_sunk_QMARK_ = function(a) {
  return cljs.core.apply.call(null, ponting_dynamics.generic.and_fn, cljs.core.vals.call(null, a))
};
ponting_dynamics.generic.game = function(a) {
  for(var b = 0;;) {
    if(cljs.core.truth_(ponting_dynamics.generic.is_sunk_QMARK_.call(null, a))) {
      return alert([cljs.core.str("You won with "), cljs.core.str(b), cljs.core.str(" shots.  Were the sailor's lives worth it, you monster?")].join(""))
    }
    var c = prompt("Yo, fire a shot whereever.  Make it a number 0-9 or you will surely miss.");
    if(null == c) {
